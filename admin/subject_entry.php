               ...
               <div class="row">
                    <div class="templatemo-line-header" style="margin-top: 0px;" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="span_blog txt_darkgrey txt_orange">Unit's Entry</span>
...
<div class="form-container">
    ...
    <div class="row">
          ...
          <div class="form-group">
            <label for="Unit" >Unit's Name </label>
           <select  class="form-control" required id="Lecturer" name="Unit">
         ...
         <div class="col-lg-3">
          ...
          <label for="Lecturer" >Lecturer Name</label>
           <select  class="form-control" required id="Lecturer" name="Lecturer">
           <option>Select Lecturer</option>
           <option >Zachary Mwangi</option>
           <option >Peninnah Limo </option>
           <option >Audrey Mbogho</option>
           <option >Arnold Peter</option>
           <option >Others</option>
           </select>
          </div>
          </div>
