	...
	<?php 
     ...
     <tbody>
          ...
          echo '<tr>';
            ...
            echo '<a class="ui mini positive button" href="teacher_update.php?id='.$post['id'].'"> <i class="glyphicon glyphicon-pencil"></i>Update</a>';
            echo "<div class='or'></div>";    
            echo '<a class="ui mini red button" href="teacher.php?id='.$post['id'].'"><i class="glyphicon glyphicon-remove"> </i>Delete</a>';
            echo "</div>";
            echo '</td>';    
           echo '</tr>';  
            }
